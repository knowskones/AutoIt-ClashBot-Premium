...
Func Initiate()
	If IsArray(ControlGetPos($Title, "_ctl.Window", "[CLASS:BlueStacksApp; INSTANCE:1]")) Then
		...
		$Checkrearm = True
		$CreateSpell = True
		GUICtrlSetState($menuItemNone, $GUI_DISABLE)
		GUICtrlSetState($menuItemDefault, $GUI_DISABLE)
		GUICtrlSetState($menuItemIron, $GUI_DISABLE)
		GUICtrlSetState($menuItemSteel, $GUI_DISABLE)
		GUICtrlSetState($menuItemGray, $GUI_DISABLE)
		GUICtrlSetState($menuItemDark, $GUI_DISABLE)
		GUICtrlSetState($menuItemBlack, $GUI_DISABLE)
		GUICtrlSetState($menuItemAlloy, $GUI_DISABLE)
		GUICtrlSetState($menuItemHex, $GUI_DISABLE)
		GUICtrlSetState($menuItemCore, $GUI_DISABLE)
		GUICtrlSetState($menuItemFresco, $GUI_DISABLE)
		GUICtrlSetState($menuItemSoft, $GUI_DISABLE)
		GUICtrlSetState($menuItemGreen, $GUI_DISABLE)
		GUICtrlSetState($menuItemTeal, $GUI_DISABLE)
		GUICtrlSetState($menuItemOrange, $GUI_DISABLE)
...
Func btnStop()
	If $RunState Then
		...
		GUICtrlSetState($menuItemNone, $GUI_ENABLE)
		GUICtrlSetState($menuItemDefault, $GUI_ENABLE)
		GUICtrlSetState($menuItemIron, $GUI_ENABLE)
		GUICtrlSetState($menuItemSteel, $GUI_ENABLE)
		GUICtrlSetState($menuItemGray, $GUI_ENABLE)
		GUICtrlSetState($menuItemDark, $GUI_ENABLE)
		GUICtrlSetState($menuItemBlack, $GUI_ENABLE)
		GUICtrlSetState($menuItemAlloy, $GUI_ENABLE)
		GUICtrlSetState($menuItemHex, $GUI_ENABLE)
		GUICtrlSetState($menuItemCore, $GUI_ENABLE)
		GUICtrlSetState($menuItemFresco, $GUI_ENABLE)
		GUICtrlSetState($menuItemSoft, $GUI_ENABLE)
		GUICtrlSetState($menuItemGreen, $GUI_ENABLE)
		GUICtrlSetState($menuItemTeal, $GUI_ENABLE)
		GUICtrlSetState($menuItemOrange, $GUI_ENABLE)
		GUICtrlSetState($menuItemRed, $GUI_ENABLE)
...
Func btnSearchMode()
	While 1
		...
		GUICtrlSetState($menuTheme, $GUI_DISABLE)
		GUICtrlSetState($btnLocateBarracks, $GUI_DISABLE)
		GUICtrlSetState($btnLocateDarkBarracks, $GUI_DISABLE)
		GUICtrlSetState($btnLocateTownHall, $GUI_DISABLE)
		GUICtrlSetState($btnLocateKingAltar, $GUI_DISABLE)
		...
		GUICtrlSetState($menuTheme, $GUI_ENABLE)
		GUICtrlSetState($btnLocateBarracks, $GUI_ENABLE)
		GUICtrlSetState($btnLocateDarkBarracks, $GUI_ENABLE)
		GUICtrlSetState($btnLocateTownHall, $GUI_ENABLE)
		GUICtrlSetState($btnLocateKingAltar, $GUI_ENABLE)
