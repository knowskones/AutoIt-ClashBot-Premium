...
Func btnTheme()
	Switch @GUI_CtrlId
		...
		Case $menuItemDefault
			$themePath = @ScriptDir & "\skins\orange.msstyles"
		Case $menuItemIron
			$themePath = @ScriptDir & "\skins\gray0.msstyles"
		Case $menuItemSteel
			$themePath = @ScriptDir & "\skins\blue1.msstyles"
		Case $menuItemGray
			$themePath = @ScriptDir & "\skins\gray5.msstyles"
		Case $menuItemDark
		...
		Case $menuItemGreen
			$themePath = @ScriptDir & "\skins\green.msstyles"
		Case $menuItemTeal
			$themePath = @ScriptDir & "\skins\blue.msstyles"
		Case $menuItemOrange
			$themePath = @ScriptDir & "\skins\orange2.msstyles"
		Case $menuItemRed
