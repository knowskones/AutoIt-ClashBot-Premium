...
EndIf
If @AutoItX64 = 1 Then
MsgBox(0, "", "Don't Run/Compile Script (x64)! try to Run/Compile Script (x86) to getting this bot work." & @CRLF & "If this message still appear, try to re-install your AutoIt with newer version.")
Exit
EndIf
...
Global $COLLECTATCOUNT = 8
Global $BSpos[2]
Global $searchGold, $searchElixir, $searchDark, $searchTrophy, $searchDead, $searchTH
Global $MinDeadGold, $MinDeadElixir, $MinDeadDark, $MinDeadTrophy, $MaxDeadTH, $MinGold, $MinElixir, $MinDark, $MinTrophy, $MaxTH
Global $chkConditions[10]
...
Global $atkTroops[9][2]
Global $fullArmy
Global $deployDeadSettings
Global $icmbDeadAlgorithm
Global $checkDeadUseKing
Global $checkDeadUseQueen
Global $checkDeadUseClanCastle
Global $checkDeadAttackTH
Global $iSkillActivateCond
Global $deploySettings
Global $icmbAlgorithm
Global $checkUseKing
Global $checkUseQueen
Global $checkUseClanCastle
Global $checkAttackTH
...
Global $itxtKingSkill
Global $itxtQueenSkill
...
Func dropHeroes($x, $y, $KingSlot = -1, $QueenSlot = -1)
While 1
...
WEnd
EndFunc
Func PrepareAttack($remaining = False)
If $remaining Then
...
Local $trophyicon = _PixelSearch(457, 403, 467, 418, Hex(0xE8C528, 6), 5)
...
Click(($THx - $LeftTHx),($THy + $LeftTHx - 30), 1, 1)
...
$atkTroops[$Barb][1] = Number(getNormal(40 +(72 * $Barb), 565))
While $atkTroops[$Barb][1] <> 0
Click(($THx + $RightTHx),($THy + $RightTHx - 10), 1, 1)
$AtkTroopTH = Number(getNormal(40 +(72 * $Barb), 565))
SetLog("Getting Attack Townhall location...", $COLOR_BLUE)
$RightTHx += 10
$i += 1
...
$atkTroops[$Barb][1] = Number(getNormal(40 +(72 * $Barb), 565))
While $atkTroops[$Barb][1] <> 0
Click(($THx + $TopTHy - 10),($THy - $TopTHy), 1, 1)
$AtkTroopTH = Number(getNormal(40 +(72 * $Barb), 565))
SetLog("Getting Attack Townhall location...", $COLOR_BLUE)
$TopTHy += 10
$i += 1
...
$atkTroops[$Barb][1] = Number(getNormal(40 +(72 * $Barb), 565))
While $atkTroops[$Barb][1] <> 0
Click(($THx -($BottomTHy + 10)),($THy - $BottomTHy), 1, 1)
$AtkTroopTH = Number(getNormal(40 +(72 * $Barb), 565))
SetLog("Getting Attack Townhall location...", $COLOR_BLUE)
$BottomTHy += 10
$i += 1
...
Next
If $THx < 287 And $THx > 584 And $THy < 465 Then
Click(($THx - $LeftTHx),($THy + $LeftTHx - 30), $numBarbPerSpot, 200)
Click(($THx + $RightTHx),($THy + $RightTHx - 10), $numBarbPerSpot, 200)
EndIf
Click(($THx + $TopTHy - 10),($THy - $TopTHy), $numBarbPerSpot, 200)
Click(($THx -($BottomTHy + 10)),($THy - $BottomTHy), $numBarbPerSpot, 200)
EndIf
EndIf
If _Sleep(1000, False) Then ExitLoop
EndIf
...
Next
If $THx < 287 And $THx > 584 And $THy < 465 Then
Click(($THx - $LeftTHx),($THy + $LeftTHx - 30), $numArchPerSpot, 200)
Click(($THx + $RightTHx),($THy + $RightTHx - 10), $numArchPerSpot, 200)
EndIf
Click(($THx + $TopTHy - 10),($THy - $TopTHy), $numArchPerSpot, 200)
Click(($THx -($BottomTHy + 10)),($THy - $BottomTHy), $numArchPerSpot, 200)
EndIf
EndIf
EndIf
ExitLoop
...
If _ColorCheck($TroopPixel, Hex(0xF8B020, 6), 5) Then Return $eBarbarian
If _ColorCheck($TroopPixel, Hex(0xD83F68, 6), 5) Then Return $eArcher
If _ColorCheck($TroopPixel, Hex(0x7BC950, 6), 5) Then Return $eGoblin
If _ColorCheck($TroopPixel, Hex(0xF8D49E, 6), 5) Then Return $eGiant
If _ColorCheck($TroopPixel, Hex(0x60A4D0, 6), 5) Then Return $eWallbreaker
If _ColorCheck($TroopPixel, Hex(0xF8F3D0, 6), 5) Then Return $eWizard
If _ColorCheck(_GetPixelColor(68 +(72 * $position), 586), Hex(0x162038, 6), 5) Then Return $eMinion
If _ColorCheck($TroopPixel, Hex(0x603B30, 6), 5) Then Return $eHog
If _ColorCheck($TroopPixel, Hex(0xB9645F, 6), 5) Then Return $eValkyrie
If _ColorCheck($TroopPixel, Hex(0xF8EB79, 6), 5) Then Return $eKing
If _ColorCheck(_GetPixelColor(68 +(72 * $position), 588), Hex(0x7031F0, 6), 5) Then Return $eQueen
If _ColorCheck(_GetPixelColor(68 +(72 * $position), 588), Hex(0x7832F8, 6), 5) Then Return $eQueen
If _ColorCheck(_GetPixelColor(68 +(72 * $position), 585), Hex(0x68ACD4, 6), 5) Then Return $eCastle
If _ColorCheck(_GetPixelColor(68 +(72 * $position), 624), Hex(0x0848ED, 6), 5) Then Return $eLSpell
Return -1
EndFunc
...
_CaptureRegion()
For $i = 0 To 4
$THLocation = _ImageSearch($atkTH[$i], 1, $THx, $THy, $Tolerance1)
...
$WallLoc = _ImageSearch($Wall[$icmbWalls + 1], 1, $WallX, $WallY, $Tolerance2)
EndIf
If $WallLoc = 1 Then
Return True
EndIf
...
For $i = 0 To 150
_CaptureRegion()
If _ColorCheck(_GetPixelColor(284, 28), Hex(0x41B1CD, 6), 20) = False Then
If _Sleep(2000) Then Return
...
$i += 1
If $i >= 20 Then
If checkNextButton() And $x <= 20 Then
Click(750, 500)
$x += 1
Else
...
Click(217, 510)
EndIf
Local $offColors[3][3] = [[0x202C0D, 10, 0], [0x68B618, 0, 25], [0x499010, 9, 25]]
Local $ShieldPixel = _WaitForMultiPixelSearch(575, 380, 586, 406, 1, 1, Hex(0xD0E978, 6), $offColors, 30)
If IsArray($ShieldPixel) Then
Click($ShieldPixel[0], $ShieldPixel[1])
EndIf
ExitLoop
WEnd
EndFunc
...
Click($barrackPos[1][0], $barrackPos[1][1])
If _Sleep(500) Then Return
BoostBuilding()
EndIf
If $ichkBoostRax3 = 1 Then
SetLog("Boosting Barrack 3...", $COLOR_BLUE)
Click($barrackPos[2][0], $barrackPos[2][1])
If _Sleep(500) Then Return
BoostBuilding()
EndIf
If $ichkBoostRax4 = 1 Then
SetLog("Boosting Barrack 4...", $COLOR_BLUE)
Click($barrackPos[3][0], $barrackPos[3][1])
If _Sleep(500) Then Return
BoostBuilding()
EndIf
If $ichkBoostKing = 1 Then
...
Click($SFactoryPos[0], $SFactoryPos[1])
If _Sleep(500) Then Return
BoostBuilding()
EndIf
...
EndFunc
Func BoostBuilding()
Local $Boost = _PixelSearch(295, 580, 406, 620, Hex(0xF8F66D, 6), 5)
...
Else
If _Sleep(100) Then Return
Click($ArmyPos[0], $ArmyPos[1])
EndIf
Local $BArmyPos = _WaitForPixelSearch(309, 581, 433, 583, Hex(0x4084B8, 6))
If IsArray($BArmyPos) = False Then
SetLog("Your Army Camp is not available", $COLOR_RED)
Else
Click($BArmyPos[0], $BArmyPos[1])
Local $Campbar = 0
Switch $icmbRaidcap
Case 0
...
EndIf
ClickP($TopLeftClient)
If _ColorCheck(_GetPixelColor(331, 330), Hex(0xF0A03B, 6), 20) = False Then Click(19, 349)
If _Sleep(500) Then Return
Click(189, 24)
While $Donate
...
EndFunc
Func CheckDonate($String, $clanString)
...
If _Sleep(1000) Then Return
_CaptureRegion(0, 0, 517, $DonatePixel[1] + 50)
If _ColorCheck(_GetPixelColor(400, $DonatePixel[1] - 5), Hex(0x507C00, 6), 10) Then
...
Func isGoldFull()
_CaptureRegion()
If _ColorCheck(_GetPixelColor(658, 33), Hex(0x000000, 6), 6) Then
If _ColorCheck(_GetPixelColor(660, 33), Hex(0xD4B100, 6), 6) Then
...
Func isElixirFull()
_CaptureRegion()
If _ColorCheck(_GetPixelColor(658, 84), Hex(0x000000, 6), 6) Then
If _ColorCheck(_GetPixelColor(660, 84), Hex(0xAE1AB3, 6), 6) Then
...
If _Sleep(500) Then Return
Local $x1 = 290, $y1 = 563, $x2 = 670, $y2 = 590
Local $offColors[3][3] = [[0x8B7E79, 26, 25], [0xE2C73A, 70, 7], [0x2B2D1F, 76, 0]]
Local $RearmPixel = _MultiPixelSearch($x1, $y1, $x2, $y2, 1, 1, Hex(0xF2F6F5, 6), $offColors, 30)
If IsArray($RearmPixel) Then
Click($RearmPixel[0] + 20, $RearmPixel[1] + 20)
...
EndIf
EndIf
Local $offColors[3][3] = [[0x95673D, 31, 26], [0xEF6CEE, 70, 7], [0x2B2D1F, 76, 0]]
Local $XbowPixel = _MultiPixelSearch($x1, $y1, $x2, $y2, 1, 1, Hex(0xF2F6F5, 6), $offColors, 30)
If IsArray($XbowPixel) Then
Click($XbowPixel[0] + 20, $XbowPixel[1] + 20)
If _WaitForPixel(350, 420, Hex(0xC83B10, 6), 20) Then
Click(515, 400)
If _Sleep(500) Then Return
...
Click($barrackPos[$i][0], $barrackPos[$i][1])
Local $TrainPos = _WaitForPixelSearch(440, 603, 694, 605, Hex(0x603818, 6))
...
$iUseStorage = 3
EndIf
If $iUseStorage <> 2 And $iGoldStorage > $iWallMinGold Then
While $iGoldStorage > $iWallMinGold And $iGoldStorage < $iBeforeGoldStorage
...
If _Sleep(600) Then ExitLoop
_CaptureRegion()
If _ColorCheck(_GetPixelColor(510, 570), Hex(0xE8C438, 6), 20) Then
If _ColorCheck(_GetPixelColor(500, 570), Hex(0xE70A12, 6), 20) Then
SetLog("Not enough Gold to upgrade wall", $COLOR_ORANGE)
ClickP($TopLeftClient)
ExitLoop
EndIf
ElseIf _ColorCheck(_GetPixelColor(557, 570), Hex(0xEAD544, 6), 20) Then
If _ColorCheck(_GetPixelColor(549, 570), Hex(0xE70A12, 6), 20) Then
SetLog("Not enough Gold to upgrade wall", $COLOR_ORANGE)
ClickP($TopLeftClient)
ExitLoop
EndIf
...
If _Sleep(2000) Then ExitLoop
Click(472, 482)
SetLog("Upgrading Done !!!", $COLOR_BLUE)
...
Return
EndIf
If $iUseStorage <> 1 And $iElixirStorage > $iWallMinElixir Then
While $iElixirStorage > $iWallMinElixir And $iElixirStorage < $iBeforeElixirStorage
...
If _ColorCheck(_GetPixelColor(596, 570), Hex(0xE70A12, 6), 20) Then
...
If _Sleep(500) Then Return
Local $ElixirUpgrade = _PixelSearch(300, 565, 629, 575, Hex(0xF759E8, 6), 10)
Local $GoldUpgrade = _PixelSearch(300, 565, 629, 575, Hex(0xF4EE54, 6), 10)
If IsArray($ElixirUpgrade) = True Then
$ElixirUpgrade1 = True
Click($ElixirUpgrade[0], $ElixirUpgrade[1])
Local $UpgradeCheck = _WaitForPixelSearch(370, 480, 520, 483, Hex(0xB9E051, 6), 10)
If IsArray($UpgradeCheck) = True Then
Click($UpgradeCheck[0], $UpgradeCheck[1])
...
Click($GoldUpgrade[0], $GoldUpgrade[1])
Local $UpgradeCheck = _WaitForPixelSearch(370, 480, 520, 483, Hex(0xB9E051, 6), 10)
If IsArray($UpgradeCheck) = True Then
Click($UpgradeCheck[0], $UpgradeCheck[1])
...
If _Sleep(500) Then Return
Click($SFactoryPos[0], $SFactoryPos[1])
Local $CreatePos = _WaitForPixelSearch(440, 596, 600, 603, Hex(0x001048, 6))
If IsArray($CreatePos) = False Then
SetLog("Spell Factory is not available", $COLOR_RED)
If _Sleep(500) Then Return
Else
Click($CreatePos[0], $CreatePos[1])
...
EndIf
If _Sleep(500) Then Return
Click($TopLeftClient[0], $TopLeftClient[1], 2, 250)
...
ClickP($TopLeftClient)
If _Sleep(500) Then ExitLoop
Click($DarkBarrackPos[$i][0], $DarkBarrackPos[$i][1])
Local $TrainPos = _WaitForPixelSearch(440, 603, 694, 605, Hex(0x603818, 6))
If IsArray($TrainPos) = False Then
...
If _Sleep(500) Then Return
Click($TownHallPos[0], $TownHallPos[1])
Local $Info = _WaitForPixelSearch(240, 581, 484, 583, Hex(0x4084B8, 6))
...
GUICtrlSetData(-1, "Barbarians|Archers|Giants|Goblins|Wizards|Nothing", "Barbarians")
GUICtrlSetState(-1, $GUI_DISABLE)
$cmbSecondTroop2 = GUICtrlCreateCombo("", 501, 101, 95, 25, BitOR($GUI_SS_DEFAULT_COMBO,$CBS_SIMPLE))
GUICtrlSetData(-1, "Barbarians|Archers|Giants|Goblins|Wizards|Nothing", "Archers")
GUICtrlSetState(-1, $GUI_DISABLE)
...
GUICtrlSetData(-1, "Barbarians|Archers|Giants|Goblins|W.Breakers|Balloon(Training Only)|Wizard|Healer(Training Only)|Dragon(Training Only)|Pekka(Training Only)|Nothing", "Barbarians")
$cmbBarrack2 = GUICtrlCreateCombo("", 301, 221, 110, 25, BitOR($GUI_SS_DEFAULT_COMBO,$CBS_SIMPLE))
GUICtrlSetData(-1, "Barbarians|Archers|Giants|Goblins|W.Breakers|Balloon(Training Only)|Wizard|Healer(Training Only)|Dragon(Training Only)|Pekka(Training Only)|Nothing|", "Archers")
...
$chkRaxRestart = GUICtrlCreateCheckbox("Restart Bluestack if fail to locate all 4 Barracks", 316, 89, 240, 17)
GUICtrlSetTip(-1, "Restart bluestack if fail to detect all 4 barracks")
$chkMultiLight = GUICtrlCreateCheckbox("Cast more than 1 Lightning", 316, 224, 150, 17)
...
Switch TrayGetMsg()
Case $tiAbout
MsgBox(64 + $MB_APPLMODAL + $MB_TOPMOST, $sBotTitle, "Clash of Clans Bot" & @CRLF & @CRLF & "Version: " & $sBotVersion & @CRLF & "Copyright 2015 Application Automation LLC.", 0, $frmBot)
Case $tiExit
ExitLoop
EndSwitch
WEnd
